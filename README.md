...
│                                                                     │
│  api.roshan-shrestha.com  ──►  API Gateway HTTP API  ──►  Lambda    │
└─────────────────────────────────────────────────────────────────────────┘
                                   │
                                   ▼
...
├── infra/          → (legacy) Terraform for ECS/ALB stack
├── ../portfolio-serverless/infra/ → Terraform for minimal serverless stack
...
- **Portfolio projects** — Case-study style cards (e.g. SaaS dashboard, job portal, booking system) powered by profile + project data from the API.
